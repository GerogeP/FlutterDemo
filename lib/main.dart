                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TabBar(
                      ...
                      indicatorColor: Colors.transparent, // 隐藏默认指示?
                      indicatorWeight: 0.0, // 完全移除下边?
                      ...
                      labelStyle: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold, // 设置选中标签字体为粗?
                      ), // 设置选中标签字体大小?4
                      unselectedLabelStyle: const TextStyle(
                        fontSize: 14,
                      ), // 设置未选中标签字体大小?4
                      indicatorSize: TabBarIndicatorSize.tab, // 指示器大小与标签一?
                      dividerHeight: 0.0, // 移除底部分割?
                      labelPadding: const EdgeInsets.symmetric(
                        horizontal: 20.0, // 增加水平内边?
                        vertical: 12.0, // 增加垂直内边?
                      ),
                      // 自定义指示器，添加边框和阴影效果
